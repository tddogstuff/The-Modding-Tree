...
calc43: {
    ...
    "Cost": {
        ...
        ["raw-html", function () { return "<h3>Cost multiplier : "+format(player.r.tetration.sub(10).div(100).max(1.09))+"x per Tetration = x"+format(player.r.tetration.sub(10).div(100).max(1.09).pow(player.r.tetration),2)+""}, { "color": "green", "font-size": "22px", "font-family": "helvetica" }],
        ["blank" , "25px"],
...
calc62: {
    ...
    "Bits": {
        ...
        ["blank","25px"],
        ["raw-html", function () { return inChallenge('e',13)?"<h3> No Basic challenge : x50.00 Bits gain":""}, { "color": "green", "font-size": "22px", "font-family": "helvetica" }],
